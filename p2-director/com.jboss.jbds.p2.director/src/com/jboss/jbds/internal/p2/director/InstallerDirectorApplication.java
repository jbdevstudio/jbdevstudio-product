 ...
 *******************************************************************************/
package com.jboss.jbds.internal.p2.director;
...
public class InstallerDirectorApplication extends  DirectorApplication {
			...
			if (!downloadOnly)
				operationStatus = PlanExecutionHelper.executePlan(result, engine, context, new NullProgressMonitor() {
					public void subTask(String name) {
						...
						File cancel = new File(destination, "cancel");
						if(cancel.canRead()) {
